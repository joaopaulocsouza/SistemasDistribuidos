...
class Middleware:
    ...
    def start_server(self):
        ...
        self.ativar_estacao('E1')  # Ativação automática da estação 1
    ...
    def atualizar_gerente(self, estacao_id):
        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
                ...
                print(f"Resposta do Gerente: {response}")
                client_socket.sendall("Oi".encode('utf-8'))
        except ConnectionError as e:
            print(f"Erro ao conectar-se ao Gerente: {e}")
